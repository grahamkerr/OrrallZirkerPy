...
def energy2vel(energy, particle = 'proton'):
    ...
    if particle == 'proton':
        ...
        E_p = constants.value('alpha particle mass energy equivalent in MeV')*1e3/4.0 #KeV/c^2
    else:
    	print('\n>>> You have not entered a valid string ("proton", "electron", "alpha")\n     Defaulting to proton')
    	E_p = constants.value('proton mass energy equivalent in MeV')*1e3 
